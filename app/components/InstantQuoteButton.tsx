...
const css = `
.btn-spotlight{--spotlight-x:50%;--spotlight-y:50%;--spotlight-on:0;position:relative;display:inline-flex;align-items:center;justify-content:center;isolation:isolate;box-sizing:border-box;padding:1.15rem 2.4rem;border-radius:999px;text-decoration:none;background:var(--background);border:1px solid var(--line);overflow:hidden;-webkit-tap-highlight-color:transparent;transition:border-color .55s cubic-bezier(.22,.61,.36,1),box-shadow .55s cubic-bezier(.22,.61,.36,1),transform .55s cubic-bezier(.22,.61,.36,1);box-shadow:0 1px 0 rgba(255,255,255,.5) inset,0 1px 2px rgba(66,73,82,.05)}
...
.btn-spotlight__label{position:relative;z-index:4;font-family:var(--font-mono-stack);font-size:.7rem;line-height:1;letter-spacing:.14em;text-transform:uppercase;color:var(--ink);transition:color .55s cubic-bezier(.22,.61,.36,1)}
